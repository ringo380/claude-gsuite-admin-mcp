...
class CreateGroupHandler(AdminToolHandler):
    ...
    name = "mcp__gsuite_admin__create_group"
...
class DeleteGroupHandler(AdminToolHandler):
    ...
    name = "mcp__gsuite_admin__delete_group"
...
class ListGroupMembersHandler(AdminToolHandler):
    ...
    name = "mcp__gsuite_admin__list_group_members"
...
GROUP_HANDLERS: List[AdminToolHandler] = [
    ListGroupsHandler("mcp__gsuite_admin__list_groups"),
    GetGroupHandler("mcp__gsuite_admin__get_group"),
    CreateGroupHandler("mcp__gsuite_admin__create_group"),
    DeleteGroupHandler("mcp__gsuite_admin__delete_group"),
    ListGroupMembersHandler("mcp__gsuite_admin__list_group_members")
]